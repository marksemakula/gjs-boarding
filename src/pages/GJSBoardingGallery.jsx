...
export default function GJSBoardingGallery() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: CREAM }}>
      ...
      {/* ── Header ─────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 shadow-lg" style={{ backgroundColor: BURGUNDY }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">

            <Link
              to="/"
              className="flex items-center gap-2 text-sm font-semibold text-white transition-all group hover:text-[#FFD700]"
            >
            ...
            <Link to="/" className="flex items-center gap-3 select-none">
              ...
              <div className="leading-tight hidden sm:block">
                <div className="text-base font-bold text-white">Gombe Junior School</div>
                <div className="text-xs font-semibold" style={{ color: YELLOW }}>Boarding Campus</div>
              </div>
            </Link>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg opacity-75 max-w-xl mx-auto" style={{ color: YELLOW }}>
              Captured moments &amp; cherished memories at Gombe Junior School, Boarding Campus
            </p>
          </motion.div>
        </div>
      </section>
