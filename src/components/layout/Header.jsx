...
const Header = () => {
  ...
  const institutions = [
    ...
    { name: 'Scooby Doo International School Uganda (SISU) - Boarding Campus', subdomain: 'sisu-boarding', path: '/institutions/scooby-boarding', description: 'International Curriculum' },
