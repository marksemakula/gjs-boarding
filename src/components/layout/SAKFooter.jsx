...
const campusesData = [
  { name: 'Kawaala Campus', path: '/institutions/sakghs-kawaala', contact: '0708 800 001 / 0708 800 003', location: 'Kawaala, Kampala' },
  { name: 'Bujuuko Campus', path: '/institutions/sakghs-bujuuko', contact: '0708 800 001 / 0708 800 003', location: 'Bujuuko, Wakiso' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3 text-sm text-white">
              ...
              <span>0708 800 001 / 0708 800 003</span>
            </div>
            <div className="flex items-center space-x-3 text-sm text-white">
